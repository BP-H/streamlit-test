...
try:
    ...
    UniverseBranch = MockHarmonizer  # type: ignore
...
def load_css() -> None:
    """Load global CSS with error handling."""
    try:
        inject_global_styles()
    except Exception as exc:  # pragma: no cover - runtime safety
        st.warning(f"CSS injection failed: {exc}")
...
def render_validation_content_safe() -> None:
...
def render_validation_ui(
    ...
    center_col: Optional[st.delta_generator.DeltaGenerator] = None,
) -> None:
